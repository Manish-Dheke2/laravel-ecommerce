                    ...
                    ->tabs([
                                ...
                                Section::make('Pricing')
                                    ->schema([
                                        ...
                                        TextInput::make('price')
                                            ...
                                            ->minValue(0)
                                            ->step(0.01)
                                            ->helperText('Selling Price') // $90 10% OFF
                                            ->prefix('$'),
                                        TextInput::make('compare_price')
                                            ->numeric()
                                            ->minValue(0)
                                            ->step(0.01)
                                            ->helperText('Original price to show discount') // $100
                                            ->prefix('$'),
                        ...
                        Tab::make('Images')
                            ...
                            ->schema([
                                ...
                                ->description('Upload multiple images. The first image will be primary image.')
                                ->schema([
