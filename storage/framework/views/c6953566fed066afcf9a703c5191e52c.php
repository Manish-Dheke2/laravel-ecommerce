                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('products.index', ['category' => $category->slug])); ?>" 
                       class="group">
                        <div class="aspect-square rounded-lg overflow-hidden bg-gray-100 mb-3">
                            ...
                            <?php else: ?>
                                <div class="w-full h-full flex items-center justify-center bg-blue-600">
                                    <span class="text-4xl text-white"><?php echo e(substr($category->name, 0, 1)); ?></span>
                                </div>
                        ...
                        <p class="text-center text-sm text-gray-500"><?php echo e($category->products_count); ?> items</p>
                    </a>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1999442305-0', $__key);
...
$__key = 'new-' . $product->id;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1999442305-1', $__key);
...
</div><?php /**PATH C:\wamp64\www\e-commerce\resources\views/livewire/home-page.blade.php ENDPATH**/ ?>